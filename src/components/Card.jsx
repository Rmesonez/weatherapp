...
export default function Card({ loadingData, weather, forecast, showData }) {
                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4 weather-img">
                                    ...
                                    <img id="card-img" src="https://images.pexels.com/photos/3617500/pexels-photo-3617500.jpeg?auto=compress&cs=tinysrgb&w=600" className="img-fluid  h-100" alt="..."/>
                                </div>
